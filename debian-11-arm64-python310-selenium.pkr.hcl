...
source "amazon-ebs" "nixtune-debian-11-arm64-python310-selenium" {
  ami_name      = "${local.name_prefix}debian-11-arm64-python310-selenium-{{isotime `2006-01-02`}}-{{timestamp}}"
...
build {
  ...
  post-processor "manifest" {
    output     = "debian-11-arm64-python310-selenium.json"
    strip_path = true
  }
}